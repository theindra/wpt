...
// @class TestHelper
//
// TestHelper is a helper utilities for orientation event tests.
//
// Usage example with device orientation:
//   const helper = new TestHelper(t, 'deviceorientation');
...
class TestHelper {
  ...
  // Resets TestHelper to default state. Removes all created virtual sensors.
  async reset() {
